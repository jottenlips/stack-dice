...
const app = new App({
    ...
    props: {
        database: ['PostgreSQL', "MongoDB", 'DynamoDB', 'MySQL', 'Neo4j', 'Redis', "SQLite", "MariaDB", "Microsoft SQL Server", "Elasticsearch"],
        backend: ['Ruby on Rails', 'Django', 'Serverless Cloud', 'Meteor', 'Flask', 'Sinatra', 'FastAPI', 'Supabase', 'Laravel', "Express", "Koa", "Spring", "ASP.NET"],
        api: ['GraphQL', 'REST'],
